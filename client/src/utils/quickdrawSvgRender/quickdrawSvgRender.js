function quickdrawSvgRender (drawing, viewBoxWidth, viewBoxHeight) {

  const width = viewBoxWidth;
  const height = viewBoxHeight;

  let svg = '';
  svg += ('<svg xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink"' + ` viewBox="0 0 ${height} ${width}"` + '>')
